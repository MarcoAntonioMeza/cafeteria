...
SECRET_KEY = 'django-insecure-(y9c)ljq5w&w&(sjm&yaiaqc-)hg+)rxaenugz&2@*hboo(vdv'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'cafe',  # El nombre de la base de datos
...
# settings.py
LOGIN_REDIRECT_URL = 'solicitud_list'  # O cualquier vista a la que quieras redirigir después de iniciar sesión
